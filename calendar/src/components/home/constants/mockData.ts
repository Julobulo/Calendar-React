...
export const mockActivities = [
  {
    ...
    entries: [
      { activity: "Studying", start: "08:00", end: "10:10", description: "started my chemistry presentation for friday" },
      { activity: "YouTube", start: "10:15", end: "11:15", description: "Watched productivity videos" },
      { activity: "Workout", start: "11:30", end: "13:00", description: "Push day: hit chest and triceps for 1h30min" },
      { activity: "Reading", start: "13:15", end: "13:45", description: "Fiction before bed" },
      { activity: "Programming", start: "14:00", end: "16:05", description: "Worked on my website's UI with my friend @Alexis" },
      { activity: "Studying", start: "17:00", end: "18:10", description: "studied a bit more for my presentation" },
    ],
  ...
  },
  {
    ...
    entries: [
      { activity: "Studying", start: "08:00", end: "10:00", description: "Focused on math exercises" },
      { activity: "YouTube", start: "10:15", end: "11:00", description: "Watched science explainers" },
      { activity: "Workout", start: "11:15", end: "11:55", description: "Cardio for 20min and abs" },
    ],
  ...
  },
  {
    ...
    entries: [
      ...
      { activity: "Chores", start: "09:45", end: "10:15", description: "Cleaned room and laundry for 20min" },
      { activity: "Reading", start: "10:30", end: "11:10", description: "finished a short novel" },
    ],
  ...
  },
  {
    ...
    entries: [
      { activity: "Studying", start: "07:30", end: "08:30", description: "Reviewed flashcards on the train" },
      { activity: "YouTube", start: "08:35", end: "08:55", description: "Watched news highlights" },
      { activity: "Travel", start: "09:00", end: "13:00", description: "Train ride from New York to Boston" },
    ],
  ...
  },
  {
    ...
    entries: [
      { activity: "Studying", start: "08:00", end: "09:20", description: "Worked on chemistry problems" },
      { activity: "Reading", start: "09:30", end: "10:20", description: "Reading in the garden" },
      { activity: "Chores", start: "10:30", end: "11:30", description: "helped grandma with cleaning her house" },
    ],
  ...
  },
  {
    ...
    entries: [
      { activity: "YouTube", start: "08:00", end: "08:40", description: "Watched judo tutorials" },
      { activity: "Workout", start: "08:45", end: "09:35", description: "Bodyweight full-body workout" },
      { activity: "Reading", start: "09:40", end: "10:00", description: "Started a new book" },
    ],
  ...
  },
  {
    ...
    entries: [
      { activity: "YouTube", start: "08:00", end: "09:30", description: "Watched documentaries" },
      { activity: "Studying", start: "09:40", end: "10:40", description: "light review of math" },
